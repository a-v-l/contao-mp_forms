 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_form_field']['mp_forms_optionalSubmit'] = ['Optionale Absende-Schaltfläche', 'Zeige eine optionale Absende-Schaltfläche an, um das Formular direkt abzuschicken auch wenn noch weitere Seiten vorhanden sind.'];
$GLOBALS['TL_LANG']['tl_form_field']['mp_forms_optionalSubmitButton'] = ['Bezeichnung der optionalen Absende-Schaltfläche', 'Bitte geben Sie die Bezeichnung der optionalen Absende-Schaltfläche ein.'];
